...
const char* g_java_class_name[] = {
        "java/lang/String",
        "java/lang/Integer",
        "com/panda/org/angrypandacv/core/OpenCVHelper"
};
...
JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *reserved)
{
    ...
    if ((clazz = env->FindClass((const char*)JNI_GET_CLASS_NAME(JAVA_CLASS_CVCORE))) == NULL)
    {
        goto error;
    }

    if (register_android_jni_core_module(env,clazz) != JNI_OK){
        goto error;
    }
...
JNIEXPORT void JNI_OnUnload(JavaVM *vm, void *reserved)
{
    ...
    k = env->FindClass((const char*)JNI_GET_CLASS_NAME(JAVA_CLASS_CVCORE));
